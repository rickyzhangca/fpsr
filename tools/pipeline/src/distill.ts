...
async function distillReactorConnectionPatches(
  bank: FrameBank,
...
interface RailPieceSample {
  visible: SpriteVariant[];
  shadows: SpriteVariant[];
}

async function sampleRailPiece(
  bank: FrameBank,
...
function appendRailPieceGroups(
  groups: LayerGroup[],
...
type RailFenceDirectionSet = Record<string, RawSprite | undefined>;
...
async function sampleRailFence(
  bank: FrameBank,
  spr: RawSprite | undefined,
...
function foldMissingRailFenceDirections(samples: RailFenceSample[]): void {
...
function appendRailFencePartGroups(
  groups: LayerGroup[],
 ...
 */
async function addRailFenceGraphics(
  bank: FrameBank,
  raw: unknown,
