...
vi.mock("react-virtuoso", () => ({
  Virtuoso: ({
    ...
    components?: {
      Scroller?: ComponentType<Record<string, unknown>>;
    };
...
import { VirtualizedJsonViewer } from "./virtualized-json-viewer";
