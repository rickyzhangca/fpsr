...
import { JsonHighlightWorkerClient } from "./jsonHighlightClient";
import type { JsonHighlightWorkerRequest, JsonHighlightWorkerResponse } from "./jsonHighlightProtocol";
